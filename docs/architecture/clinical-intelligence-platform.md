...
docs/
  architecture/         current architecture and evolution rules
  testing/              testing strategy and quality expectations
...
See [`../testing/testing-strategy.md`](../testing/testing-strategy.md) for commands and detailed expectations.
